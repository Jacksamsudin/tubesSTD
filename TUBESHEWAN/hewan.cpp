    ...
    address searchByName(address root, string nama) {
        ...
        address leftResult = searchByName(root->left, nama);
        if (leftResult != nullptr) {
            return leftResult;
        }

        return searchByName(root->right, nama);
    }
    ...
    void tampilkanMenu() {
        ...
        cout << "5.  Cari Hewan (Nama)\n";
        cout << "6.  Cari Hewan (Berat)\n";
        cout << "7.  Tampilkan Per Habitat\n";
        cout << "8.  Hewan yang Dilindungi\n";
        cout << "9.  Hapus Hewan\n";
        cout << "10. Statistik\n";
        cout << "0.  Keluar\n";
        cout << "-----------------------------------------\n";
